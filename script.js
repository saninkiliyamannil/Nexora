...
;
        ...
        (() => {
            const stats = [
                ...
                { val: '847', lbl: 'COMMITS THIS YEAR' },
                { val: '230+', lbl: 'DESIGNS SHIPPED' },
                { val: '94', lbl: 'VULNS PATCHED' },
                { val: '61', lbl: 'TRACKS PRODUCED' },
                { val: '47', lbl: 'SITES DEPLOYED' },
                { val: '12', lbl: 'FIREWALLS BUILT' },
                { val: '180K', lbl: 'WORDS WRITTEN' },
                { val: '4.9', lbl: 'AVG CLIENT RATING' },
                { val: '38', lbl: 'VIDEOS EDITED' },
                { val: '99%', lbl: 'UPTIME RECORD' },
            ];
